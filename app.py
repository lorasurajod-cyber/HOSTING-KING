...
app.secret_key = os.environ.get("SECRET_KEY") or "shanwaj-fixed-secret-change-in-prod-2026"
...
def internal_error(e):
    ...
    show = os.environ.get("SHOW_ERRORS", "1") == "1"
    if show:
        return f"<pre style=\'color:#fff;background:#111;padding:1rem;white-space:pre-wrap\'>{tb}</pre>", 500
    return "Server error. Check Deploy Logs.", 500
